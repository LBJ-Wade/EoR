...
# where <start_channel> is the first frequency slice to be 'observed' in the
# lightcone (usually 0). and <end_channel> is the final frequency slice to be
# 'observed' in the lightcone.

# USAGE:
# You must provide three lightcones (one containing cosmological signal, one
# with foregrounds, and a third filled with zeros for noise to be added upon).
