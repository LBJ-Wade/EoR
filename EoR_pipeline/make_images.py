...
from __future__ import (absolute_import, division, print_function,
                        unicode_literals)
import numpy as np
from math import sin, asin, pi, radians, degrees
import sys
import time
import os
import shutil
...
def fov_to_cellsize(fov_deg, size):
    rmax = sin(radians(fov_deg) * 2.0)
    inc = rmax / (0.5 * size)
    return degrees(asin(inc)) * 3600.0
...
if __name__ == '__main__':
    ...
    visDir = '../Vis'
    # cw Nb. visDir is a variable in Emma's, maybe it should become another
    # global
