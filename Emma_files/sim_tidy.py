...
def cube_to_osm(sky_root_name, fov_deg, freq, ra0_deg, dec0_deg, \
    ...
    cube_filename = 'models/%s.fits' % (sky_root_name)
    ...
    # -------------------------------------------------------------------------
    im0 = np.array(cube, dtype=np.float32)
...
#       SKA EOR0
    ...
    if generate_data == True and mode == 1:
        ...
        cube_to_osm(sky_root_name, fov_deg, freq, ra0_deg, dec0_deg, \
